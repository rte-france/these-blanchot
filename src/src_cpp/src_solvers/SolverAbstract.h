...
public:
    /**
    * @brief Fix first-stage variables to the values contained in x0
    * 
    * @param x0: vector of values to which fix the first-stage variables
    */
    virtual void fix_first_stage(std::vector<double> const& x0) = 0;
	
    /**
    * @brief add a cut to the problem
    * 
    * @param s      : vector of the subgradients
    * @param x0     : vector of the values of first-stage variables in which derive the cut
