...
void SolverAbstract::get_obj(double* obj, int first, int last) {}
...
void SolverAbstract::chgobj(int nels, const int* mindex, const double* obj) {}

void SolverAbstract::chgbounds(int nbds, const int* mindex, const char* qbtype, const double* bnd) {}

void SolverAbstract::get_basis(int* rstatus, int* cstatus) {}
