...
*/
class WorkerMasterXPRS : public WorkerMaster {
public:
...
public :
	WorkerMasterXPRS();
	WorkerMasterXPRS(Str2Int const & variable_map, std::string const & problem_name, BendersOptions const & options, int nslaves = 1);
	virtual ~WorkerMasterXPRS();
