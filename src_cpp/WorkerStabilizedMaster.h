...
public:
	...
	WorkerStabilizedMaster(std::map<std::string, int> const & variable_name, std::string const & problem_name, DblVector const & slave_weight, BendersOptions const & options, int nslaves=1);
